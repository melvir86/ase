...
(change the value of variable codio_subdomain_endpoint to the correct latest codio subdomain = 'https://[codio-domainname1]-[codio-domainname2]-8080.codio-box.uk/api')
